...
if ! gcc -Wall ast/y.tab.c ast/lex.yy.c ast/ast.c ast/node_utils.c exprtree/exprtree.c generator/generator.c utility/error.c symbol_table/symbol_table.c spec/expl.c -o compiler; then
    echo ""
